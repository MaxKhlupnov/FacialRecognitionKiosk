...
namespace FacialRecognitionDoor.Helpers
{
    ...
    public class WebcamHelper
    {
        ...
        {
            return await CapturePhoto(this.mediaCapture);
        }
        ...
        /// File is stored in a temporary folder and could be deleted by the system at any time.
        /// </summary>
        public static async Task<StorageFile> CapturePhoto(MediaCapture mediaControl)
        {
            ...
            await mediaControl.CapturePhotoToStorageFileAsync(ImageEncodingProperties.CreateJpeg(), file);
